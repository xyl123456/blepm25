...
#undef UTXxIE
#undef UTXxIF
#if (HAL_UART_ISR == 2)//#if (HAL_UART_ISR == 1)
/*
#define PxOUT                      P0
#define PxDIR                      P0DIR
#define PxSEL                      P0SEL
...
#if (HAL_UART_ISR == 2)//#if (HAL_UART_ISR == 1)
/*
#define HAL_UART1_PERCFG_BIT        0x01         // USART0 on P0, Alt-1; so clear this bit.
#define HAL_UART1_Px_RX_TX          0x0C         // Peripheral I/O Select for Rx/Tx.
#define HAL_UART1_Px_RTS            0x20         // Peripheral I/O Select for RTS.
#define HAL_UART1_Px_CTS            0x10         // Peripheral I/O Select for CTS.
#else
*/
#define HAL_UART1_PERCFG_BIT        0x02         // USART1 on P1, Alt-2; so set this bit.
#define HAL_UART1_Px_RTS            0x20         // Peripheral I/O Select for RTS.
#define HAL_UART1_Px_CTS            0x10         // Peripheral I/O Select for CTS.
